...
namespace HtmlToMarkDown.Test
{
    ...
    public class MarkdownTests
    {
        ...
        {
            Assert.AreEqual("# Heading Text\r\n\r\n", MarkDownDocument.FromHtml("<h1>Heading Text</h1>").TrimStart());
            Assert.AreEqual("## Heading Text\r\n\r\n", MarkDownDocument.FromHtml("<h2>Heading Text</h2>").TrimStart());
            Assert.AreEqual("### Heading Text\r\n\r\n", MarkDownDocument.FromHtml("<h3>Heading Text</h3>").TrimStart());
            Assert.AreEqual("#### Heading Text\r\n\r\n", MarkDownDocument.FromHtml("<h4>Heading Text</h4>").TrimStart());
            Assert.AreEqual("##### Heading Text\r\n\r\n", MarkDownDocument.FromHtml("<h5>Heading Text</h5>").TrimStart());
        }
